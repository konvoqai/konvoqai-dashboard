...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold tracking-[-0.01em] transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "border border-[var(--accent-raw)] bg-[var(--accent-raw)] text-[#FFFFFF] shadow-[var(--shadow-button)] hover:border-[var(--accent-strong)] hover:bg-[var(--accent-strong)] active:border-[var(--accent-active)] active:bg-[var(--accent-active)]",
        destructive:
          "border border-red-400/20 bg-red-500/85 text-white hover:bg-red-500 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline:
          "border border-white/10 bg-[color:var(--surface)] text-[var(--text-1)] shadow-[var(--shadow-card)] hover:bg-[color:var(--surface-2)]",
        secondary: "border border-white/8 bg-[color:var(--surface-2)] text-[var(--text-1)] hover:bg-[color:var(--surface)]",
        ghost:
